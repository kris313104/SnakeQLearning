...
UNREALROOTPATH = /home/megamarchewa/UnrealEngine
GAMEPROJECTFILE =/home/megamarchewa/Documents/Unreal Projects/SnakeGameQLearning/SnakeGameQLearning.uproject

TARGETS = \
	SnakeGameQLearning-Linux-Debug  \
	SnakeGameQLearning-Linux-DebugGame  \
	SnakeGameQLearning-Linux-Test  \
	SnakeGameQLearning-Linux-Shipping  \
	SnakeGameQLearning \
	SnakeGameQLearningEditor-Linux-Debug  \
	SnakeGameQLearningEditor-Linux-DebugGame  \
	SnakeGameQLearningEditor-Linux-Test  \
	SnakeGameQLearningEditor-Linux-Shipping  \
	SnakeGameQLearningEditor \
...
StandardSet: RequiredTools UnrealFrontend SnakeGameQLearningEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug SnakeGameQLearningEditor-Linux-Debug


SnakeGameQLearning-Linux-Debug:
	 $(PROJECTBUILD) SnakeGameQLearning Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SnakeGameQLearning-Linux-DebugGame:
	 $(PROJECTBUILD) SnakeGameQLearning Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SnakeGameQLearning-Linux-Test:
	 $(PROJECTBUILD) SnakeGameQLearning Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SnakeGameQLearning-Linux-Shipping:
	 $(PROJECTBUILD) SnakeGameQLearning Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SnakeGameQLearning:
	 $(PROJECTBUILD) SnakeGameQLearning Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

SnakeGameQLearningEditor-Linux-Debug:
	 $(PROJECTBUILD) SnakeGameQLearningEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SnakeGameQLearningEditor-Linux-DebugGame:
	 $(PROJECTBUILD) SnakeGameQLearningEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SnakeGameQLearningEditor-Linux-Test:
	 $(PROJECTBUILD) SnakeGameQLearningEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SnakeGameQLearningEditor-Linux-Shipping:
	 $(PROJECTBUILD) SnakeGameQLearningEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SnakeGameQLearningEditor:
	 $(PROJECTBUILD) SnakeGameQLearningEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
